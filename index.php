...
<head>
    ...
    <?php
        $query = mysqli_query($config, "SELECT logo from tbl_setting");
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Sign In</h5>
                            <div class="batas"></div>
                        </div>
                    </div>
                    <!-- Logo and title END -->
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nim, admin FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");

                                if(mysqli_num_rows($query) > 0){
                                    list($id_user, $username, $nim, $admin) = mysqli_fetch_array($query);
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="button" class="btn-large waves-effect waves-light orange col s12" name="register">REGISTER</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
