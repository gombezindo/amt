...
<head>
    ...
    <?php
        $query = mysqli_query($config, "SELECT ico from tbl_setting");
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Aplikasi Manajemen Tugas</h5>
                            <?php
                                if(!empty($data['logo'])){
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nim, level FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");
